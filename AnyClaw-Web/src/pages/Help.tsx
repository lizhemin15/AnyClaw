...
export default function Help() {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      <h1 className="text-xl font-semibold text-slate-800 mb-2">使用帮助</h1>
      <p className="text-sm text-slate-500 mb-6">OpenClaw 是效率工具、一人公司的底座，帮你用 AI 员工完成复杂任务。</p>
      ...
      <div className="space-y-8">
        ...
        <section className="bg-white rounded-xl border border-slate-200 p-4 sm:p-6">
          ...
          <p className="text-sm text-slate-600 mb-4">
            在网页端与你的 AI 助手协作时，可直接发送消息完成飞书绑定，无需手动编辑配置文件。
          </p>
          <div className="space-y-4 text-sm">
            ...
            <div>
              ...
              <p className="text-slate-600 mb-2">进入员工对话页，发送以下任一格式的消息：</p>
              ...
              <p className="text-slate-500 mt-2 text-xs">AI 会自动解析并写入配置，约 3 秒后助手重启，飞书通道即可使用。</p>
            </div>
            <div>
              <h3 className="font-medium text-slate-700 mb-2">第四步：在飞书中使用</h3>
              <p className="text-slate-600">在飞书中搜索你创建的应用，发送消息即可与你的 AI 助手对话。</p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white rounded-xl border border-slate-200 p-4 sm:p-6">
          ...
          <ul className="space-y-2 text-sm text-slate-600">
            <li>· <strong>招聘员工</strong>：需要消耗 {adoptCost} 金币，招聘后员工永久存在</li>
            <li>· <strong>对话消耗</strong>：按 token 计费，每 {tokensPerEnergy} token 约消耗 1 金币</li>
            <li>· <strong>包月</strong>：可为单个员工包月（{monthlyCost > 0 ? `${monthlyCost} 金币/次` : '管理员未开放'}），包月后 30 天内对话不消耗金币</li>
        ...
        <section className="bg-white rounded-xl border border-slate-200 p-4 sm:p-6">
          ...
          <dl className="space-y-3 text-sm">
            <div>
              <dt className="font-medium text-slate-700">员工显示「创建中」很久？</dt>
            ...
            <div>
              ...
              <dd className="text-slate-600 mt-0.5">需至少 {minEnergy} 金币才能发起对话。可通过充值获取，或为员工包月后 30 天内不消耗金币。</dd>
            </div>
          </dl>
        </section>
      </div>
