...
CONTAINER_NAME="anyclaw-test-ergo"
IRC_PORT=6667
...
echo ""
echo "Add this to your ~/.anyclaw/config.json under \"channels\":"
echo ""
echo '  "irc": {'
echo '    "enabled": true,'
...
echo '  }'
echo ""
echo "Then run anyclaw:"
echo "  cd packages/anyclaw-server && go run ./cmd/anyclaw gateway"
echo ""
