...
import (
	...
	anthropicprovider "github.com/anyclaw/anyclaw-server/pkg/providers/anthropic"
)
...
func createClaudeTokenSource() func() (string, error) {
	return func() (string, error) {
		...
		if cred == nil {
			return "", fmt.Errorf("no credentials for anthropic. Run: openclaw auth login --provider anthropic")
		}
