...
func TestResolveWorkspace(t *testing.T) {
	result := ResolveWorkspace("/home/user/.anyclaw")
	assert.Equal(t, "/home/user/.anyclaw/workspace", result)
}

func TestRelPath(t *testing.T) {
	result := RelPath("/home/user/.anyclaw/workspace/file.txt", "/home/user/.anyclaw")
...
func TestResolveTargetHome(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Equal(t, filepath.Join(home, ".anyclaw"), result)
}
