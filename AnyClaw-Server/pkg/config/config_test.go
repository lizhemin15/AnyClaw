...
func TestDefaultConfig_WorkspacePath_Default(t *testing.T) {
	...
	t.Setenv("ANYCLAW_HOME", "")
	// Set a known home for consistent test results
	t.Setenv("HOME", "/tmp/home")

	cfg := DefaultConfig()
	want := filepath.Join("/tmp/home", ".anyclaw", "workspace")
...
func TestDefaultConfig_WorkspacePath_WithAnyClawHome(t *testing.T) {
	t.Setenv("ANYCLAW_HOME", "/custom/anyclaw/home")

	cfg := DefaultConfig()
	want := "/custom/anyclaw/home/workspace"

	if cfg.Agents.Defaults.Workspace != want {
		t.Errorf("Workspace path with ANYCLAW_HOME = %q, want %q", cfg.Agents.Defaults.Workspace, want)
	}
}
